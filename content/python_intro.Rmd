...
* tout ce qui peut être fait avec un générateur peut l'être avec une classe itérateur (paragraphe précédent). Ce qui rend le générateur plus compacte est que les méthode `__iter__()` et `next()` sont crées automatiquement.
